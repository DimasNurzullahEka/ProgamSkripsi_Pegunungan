...
<body>
  ...
  @yield('content')
    ...
    <script>
        function submitForm() {
            // Get all checkboxes
            var checkboxes = document.querySelectorAll('input[name="is_checked[]"]');
            var allChecked = true;
            ...
            // Redirect or show alert based on checkbox status
            if (allChecked) {
                window.location.href = '/dataForm'; // Replace with the URL of the next page
            } else {
